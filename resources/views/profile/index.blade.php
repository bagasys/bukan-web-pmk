        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center">
                    @role('mahasiswa')
                    <img class="profile-user-img img-fluid img-circle" src="{{ url('/avatar_mahasiswa/'.$profile->model->avatar) }}" alt="User profile picture">
                    @endrole
                    @role('dosen')
                    <img class="profile-user-img img-fluid img-circle" src="{{ url('/avatar_dosen/'.$profile->model->avatar) }}" alt="User profile picture">
                    @endrole
                    @role('alumni')
                    <img class="profile-user-img img-fluid img-circle" src="{{ url('/avatar_alumni/'.$profile->model->avatar) }}" alt="User profile picture">
                    @endrole
                </div>
