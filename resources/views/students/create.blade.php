                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Masukkan department mahasiswa" value="{{old('department')}}">
                                    @error('department')
                                    <span class="error invalid-feedback">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Masukkan alamat mahasiswa" value="{{old('current_address')}}">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('guardian_name') ? 'is-invalid' : ''}}"
                                           id="guardian_name" name="guardian_name"
                                           placeholder="Masukkan NRP mahasiswa" value="{{old('guardian_name')}}">
                                    @error('guardian_name')
                                    <span class="error invalid-feedback">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('guardian_phone') ? 'is-invalid' : ''}}"
                                           id="guardian_phone" name="guardian_phone"
                                           placeholder="Masukkan Nomor Telepon Wali" value="{{old('guardian_phone')}}">
