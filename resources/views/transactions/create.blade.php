                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('sender_name') ? 'is-invalid' : ''}}" id="sender_name" name="sender_name"
                                        placeholder="Masukkan nama pengirim" value="{{old('sender_name')}}" >
                                    @error('sender_name')
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('sender_account') ? 'is-invalid' : ''}}" id="sender_account" name="sender_account"
                                           placeholder="Masukkan rekening pengirim" value="{{old('sender_account')}}">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control {{$errors->has('verified_date') ? 'is-invalid' : ''}}" id="verified_date" name="verified_date"
                                           placeholder="Masukkan tanggal" value="{{old('verified_date')}}">
                                    @error('verified_date')
                                        <span class="error invalid-feedback">{{$message}}</span>
                                    @enderror
                                </div>
