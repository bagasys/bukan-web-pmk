     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="radio" id="male" name="sex" value="Laki-laki">
                <label for="laki-laki">Laki-laki</label><br>
                <input type="radio" id="female" name="sex" value="Perempuan">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="phone" class="form-control" placeholder="0878xxxxxx">
            </div>
        </div>
